...
//  exit;
                            ...
                            ?>
                                ...
                                <tr class="rep">
                                     ...
                                     <td class="report"><?php echo $tdtls->name; ?>
                                     <td class="report"><?php echo $tdtls->floor_no; ?>
                                     <td class="report"><?php echo $tdtls->room_no; ?>
                                     <td class="report"><?php echo $tdtls->agree_st_dt; ?>
                                     <td class="report"><?php echo $tdtls->agree_end_dt; ?>
                                     <td class="report"><?php echo $tdtls->covd_area; ?>
                                     <td class="report"><?php echo $tdtls->rent_per_sqrt; ?>
                                     <td class="report"><?php echo $tdtls->rent_per_mnth; ?>
