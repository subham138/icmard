		...
		<div class="content-wrapper">
          ...
          <span class="confirm-div" style="float:right; color:green;">
		   ...
		   <div class="form-group row">
			...
			<div class="col-sm-4">
			  <input type="text" class="form-control" placeholder="" name="instl_loc" id="instl_loc" required>
			</div>
				</div>  
	   <div class="form-group row">
				<div class="col-sm-1">
				...
				<div class="col-sm-1">
				 ...
				 <div class="col-sm-4">
				  <input type="date" class="form-control" placeholder="" name="to_dt" id="to_dt" required>
				  </div>	
	   </div>
	   	   <div class="form-group row">
