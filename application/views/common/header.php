        ...
        <li>
          ...
          <ul class="submenu">
            ...
            <!-- <li class="link-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-mobile"></i>Stock IN<i class="fa fa-chevron-down"></i></a>
            ...
            <li>
              <a href="#stockIn" data-toggle="collapse" data-target="#stockIn">
                Stock IN
                <i class="fa fa-chevron-down float-right" style="position:static;"></i>
              </a>
              <div class="collapse" id="stockIn" aria-expanded="false">
                <ul class="flex-column nav">
                  <li class="text-center">
                    <a href="<?= base_url() ?>index.php/stock/in_list">Individual</a>
                  </li>
                  <li class="text-center">
                    <a href="<?= base_url() ?>index.php/stock/mul_in_list">Bulk</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li>
              <a href="#stockOut" data-toggle="collapse" data-target="#stockOut">
                Stock Out
                <i class="fa fa-chevron-down float-right" style="position:static;"></i>
              </a>
              <div class="collapse" id="stockOut" aria-expanded="false">
                <ul class="flex-column nav">
                  <li class="text-center">
                    <a href="<?= base_url() ?>index.php/stock/out_list">Individual</a>
                  </li>
                  <li class="text-center">
                    <a href="<?= base_url() ?>index.php/stock/mul_out_list">Bulk</a>
                  </li>
                </ul>
              </div>
            </li>
